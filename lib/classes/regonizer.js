(function() {
  ...
  module.exports = Regonizer = (function(superClass) {
    ...
    Regonizer.prototype.open = function(fileName, brightness) {
      var me;
      me = this;
      ...
      if (this.fileName) {
        return cv.readImage(this.fileName, function(err, im) {
          if (err) {
            ...
            if (im.width() === 0) {
              return me.emit('error', new Error('zero size'));
            } else {
    ...
    Regonizer.prototype.outerbounding = function() {
    ...
    Regonizer.prototype.sortboxAfterText = function() {
